...
globalHotkeys.add
	...
	callback: ->
		if Meteor.user()
			if Meteor.userId() in ['DyNFLrLXySaYuShto','Ya7hfyCpyKBhZihcD']
...
# 	combo: "r s"
# 	callback: ->
#         if Meteor.userId() and Meteor.userId() in ['DyNFLrLXySaYuShto','Ya7hfyCpyKBhZihcD']
...
globalHotkeys.add
	combo: "g i"
	callback: -> Router.go '/ingredients'
globalHotkeys.add
	combo: "g t"
